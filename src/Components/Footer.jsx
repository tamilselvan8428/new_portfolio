      ...
      <div className="footer-container">
        <div className="footer-content">
          <div className="footer-section brand-section">
            ...
            <p className="footer-tagline">Full Stack Developer & Data Analyst</p>
            <p>Building innovative, high-performance, and visually stunning digital solutions with modern web technologies.</p>
          </div>
          ...
          <div className="footer-section connect-section">
            ...
            <div className="social-links">
              ...
              <a href="mailto:tamilselvan24650@gmail.com">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="footer-bottom">
          <p>&copy; {new Date().getFullYear()} Tamil Selvan. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
